...
class MainApp(QMainWindow):
    ...
    def init_UI(self):
        ...
        self.setStyleSheet("""
            QMainWindow {
                background-color: #2f2f2f;   /* 设置主窗口背景为深灰色 */
            }
            QPushButton {
                border-radius: 5px;              
                background-color: #666666;       /* 浅灰色背景 */
            ...
            QPushButton:hover {
                background-color:  #3f3f3f;       /* 悬停时稍深的灰色 */
                border: 1px solid  #3f3f3f;       /* 悬停时的边框颜色 */
            }

            QPushButton:pressed {
                background-color: #1a1a1a;       /* 点击时更深的灰色 */
                border: 2px solid #1a1a1a;       /* 点击时的边框颜色 */
            }
            ...
            QLineEdit {
                ...
                border: 1px solid #1a1a1a;              /* 边框颜色和宽度 */
                padding: 5px;                           /* 内边距 */
            ...
            QLineEdit:hover {
                border: 1px solid #3f3f3f;              /* 鼠标悬停时的边框颜色 */
                background-color: #3f3f3f;              /* 鼠标悬停时的背景色 */
            }
            QLineEdit:focus{
                border: 1px solid #666666;              /* 焦点时的边框颜色 */
                background-color: #666666;              /* 焦点时的背景色 */
            }        
            QTextEdit {
                background-color: #1a1a1a;  /* 灰色背景 */
                border: 1px solid #1a1a1a;  /* 边框颜色 */
    ...
    def apply_shadow_effect(self,widget):
        ...
        shadow_effect.setBlurRadius(15)  # 增加模糊半径以使阴影更柔和
        shadow_effect.setXOffset(5)      # X轴偏移
        shadow_effect.setYOffset(5)      # Y轴偏移
        shadow_effect.setColor(QColor(0, 0, 0, 100))  # 设置较淡的黑色阴影颜色
